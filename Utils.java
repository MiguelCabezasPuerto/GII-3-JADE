...
public class Utils 
{
     ...
     */
    public static void enviarMensaje(Agent agent, String tipo, Object objeto, int mensaje, String clase)
    {
    ...
    public static void enviarMensajeAUsuarioAlojamiento(Agent agent, String tipo, Object objeto)
    {
        DFAgentDescription[] dfd;
        dfd=buscarAgentes(agent, tipo);
        int encontrado=0;
        Alojamiento a2=(Alojamiento)objeto;
        ...
        try
        {
            ...
            {	
            		...
            		ACLMessage aclMessage = new ACLMessage(ACLMessage.REQUEST);
                	for(int i=0;i<dfd.length;i++) {
                		if(dfd[i].getName().getLocalName().equalsIgnoreCase(a2.getUsuarioEmisor())) {
    	        		aclMessage.addReceiver(dfd[i].getName());
    	        		encontrado=1;
    	        		break;
                		}
            		...
            		agent.send(aclMessage); 
                		...
                		System.out.printf("Usuario noo encontrado\n");
                	}
    ...
    public static void enviarMensajeAUsuarioOcio(Agent agent, String tipo, Object objeto)
    {
        DFAgentDescription[] dfd;
        dfd=buscarAgentes(agent, tipo);
        int encontrado=0;
